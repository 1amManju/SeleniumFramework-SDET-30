...
public class CreateContactWithOrgandLeadSourceTest extends BaseClass
{
	@Test
	public void createContactWithOrgTest() throws Throwable
	{
		...
		String lastName = eLib.readDataFromExcel("Contact", 7, 2);
		String orgName = eLib.readDataFromExcel("Contact", 7, 3)+""+jLib.getRandomNumber();
		String leadSource = eLib.readDataFromExcel("Contact", 7, 4);
